...
class ObjectServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.SendObject = channel.unary_unary(
                '/jsonvsprotobuf.ObjectService/SendObject',
                request_serializer=object__pb2.Object.SerializeToString,
...
def add_ObjectServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendObject': grpc.unary_unary_rpc_method_handler(
                    servicer.SendObject,
                    request_deserializer=object__pb2.Object.FromString,
                    response_serializer=object__pb2.ObjectResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'jsonvsprotobuf.ObjectService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('jsonvsprotobuf.ObjectService', rpc_method_handlers)
...
class ObjectService:
    ...
    def SendObject(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/jsonvsprotobuf.ObjectService/SendObject',
            object__pb2.Object.SerializeToString,
